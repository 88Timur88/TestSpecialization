...
public class Animal {
    ...
    protected Animal(String name, LocalDate birthday, AnimalsType type) {
        this.name = name;
    ...
    protected Animal(String name, LocalDate birthday, Set<String> commands, AnimalsType type) {
        this.name = name;
        this.birthday = birthday;
    ...
    public String toString() {
        ...
        String commandsAll = "Команды, которые умеет делать животное: ";
        for (String command : commands) {
            if (commandsAll != "Команды, которые умеет делать животное: ")
                commandsAll += ", ";
    ...
    public static Animal parse(CharSequence input) throws RuntimeException {
        ...
        try {
            ...
            AnimalsType type = AnimalsType.valueOf(cap);
            String name = split[1];
